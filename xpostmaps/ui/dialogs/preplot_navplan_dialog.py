"""Manage preplot / navplan files in a dedicated non-modal window."""
...
class PreplotNavplanDialog:
    ...
    def open(
        ...
        def build(dialog: SingleInstanceDialog) -> None:
            ...
            hint = QLabel(
                "Import preplot (.p111/.p190 start/end lines, doglegs) or "
